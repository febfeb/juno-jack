...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '/private/storage/app/images/posts'; // Relative to domain name
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]
	//$config['img_path'] = '/private/storage/app/images/posts';
	//$config['upload_path'] = 'localhost/sholawat'.$config['img_path'];
